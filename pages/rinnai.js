                      ...
                      <Box>
                        <Grid container>
                          ...
                          <Grid item xs={6} className="d-flex align-items-center">
                            <Box p={3}>
                              <Image layout='responsive' src={BrandLogo} alt="Rinnai Logo" title='Rinnai Logo' />
                            </Box>
                          </Grid>
                        </Grid>
                      </Box>
                ...
                <Box p={3}>
                  <Grid container>
                    <Grid item xs={12} md={11}>
                      <BrandDetails title='Get the best Rinnai products servicing at relative ease' list={true} ListArray={ListArray} />
                    </Grid>
                  </Grid>
                </Box>
              </Grid>
